...
try :
    ...
    while True: 
      ...
      # DC 모터 오른쪽 
        ...
        motor_distanceA = motorDegA * (math.pi / 180) / wheel * 264
        ...
        target_degB = motorDegB * (math.pi / 180) / wheel * 264
        errorB = target_degB - motorDegB
        ...
        motor_distanceB = motorDegB/(wheel*264)
